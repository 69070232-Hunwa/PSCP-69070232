...
```text
รับค่าช่วงจำนวน A B แล้วให้แสดงเลขในช่วงที่หารด้วย d แล้วเหลือเศษ r
```
...
```text
รับค่าช่วงจำนวนแล้วนำแต่ละตัวมาหารด้วย d แล้วบวก r ว่าได้ค่านั้นไหม
```
...
```text
รับค่าช่วงจำนวน A B ตามด้วยตัวหารและเศษ​ สร้างตัวแปรให้เก็บค่า ใช้ loop เชคค่าแต่ละตัวในช่วงจำนวน ถ้าหาร d แล้วได้เศษ r ให้เพิ่มจำนวนในตัวแปรที่สร้างทีละ 1
```
...
```text
กรณีที่เลขขอบในช่วงจำนวนหาร d ได้เศษ r
```
