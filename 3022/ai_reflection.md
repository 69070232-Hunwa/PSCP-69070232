...
| OJ submission ID, if submitted | 554817 |
| OJ status | Pass |
...
```text
ส่ง Code ในระะบบ แล้วขึ้น 
E:  19, 13: Possibly using variable 'cel' before assignment
E:  27, 13: Possibly using variable 're' before assignment
ถามว่าต้องแก้เป็นยังไง
```
...
```text
ต้องมีแผนสำรองในกรณีพิมพ์หน่วยอื่น ไม่ให้โปรแกรมพัง
