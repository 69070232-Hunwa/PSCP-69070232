...
```text
รับค่า input เป็นค่าและหน่วยของอุณภูมิตั้งต้น แล้วก็หน่วยที่ต้องการจะเปลี่ยนตามสูตร
```
...
```text
สร้างค่า input ทั้งหมด 3 ค่า จากนั้นนำค่าที่รับมาแทนในสูตรสมการของหน่วยที่ต้องงการเปลี่ยน
```
...
```text
สร้างฟังก์ชัน temperature รับค่า input 3 ค่า คือ ค่าอุณหภูมิ หน่วยของค่าอุณหภูมิ และหน่วยที่ต้องการจะแปลง จากนั้นต้องแปลงค่าที่รับเป็น Celsius ก่อน โดยจัดรูปสมการให้อยู่ในเทอม ของ Celsius เมื่อได้ค่าที่เป็นหน่วย Celsius แล้ว ให้นำมาเข้าสูตรตรามสมการในโจทย์ได้เลย C, F, K, R จากนั้นแสดงค่าอุณหภูมิ จากนั้นเรียกใช้ฟังก์ชัน  temperature
```
...
```text
กรณีที่เป็นหน่วย C ทั้ง input และ output
```
