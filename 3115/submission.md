...
```text
รับค่าเวลาเปิดปิดของแต่ละร้าน และค่าเวลาที่ต้องการตรวจสอบว่าในเวลานั้นมีร้านเปิดกี่ร้าน
```
...
```text
รับค่าช่วงเวลสเปิดปิดของร้าน และเวลาที่ต้อตรวจสอบ แล้วตรวจสอยว่าในช่วงขอเวลานั้นมีร้านเปิดกี่ร้าน
```
...
```text
รับค่าจำนวนร้าน จำนวนเวลาที่ต้องการตรวจสอบ แล้วใช้ loop รับช่วงเวลาเปิดปิดของตามจำนวน ตามด้วยเวลาที่จะตรวจสอบ นำค่าช่วงเวลาเก็นใน list จากนั้นดูว่าในช่วงเวลานั้นเปิดกี่ร้าน ให้บวกเพิ่มไว้ในอีก list แล้วแสดงค่า
```
