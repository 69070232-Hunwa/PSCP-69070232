...
| OJ submission ID, if submitted | 623408 |
| OJ status | Pass |
...
```text
ต้องเทียบดูตัวเลขเวลาที่จะตรวจสอบ และเก็บช่วงเวลาที่รับค่าใน list
```
...
```text
ให้ AI ให้ตัวอย่างมา แล้วลองเขียนด้วยวิธีของตัวเอง
```
...
```text
เก็บค่าช่วงจำนวนไว้ใน list แล้วค่อยตรวจทีละตัวได้
ใช้ * เพื่อในแสดงผลแค่ค่าใน list
```
