...
| OJ submission ID, if submitted | 653534 |
| OJ status | Pass |
...
```text
เว้นวรรคข้อความบรรทัดอื่นให้เท่ากับบรรทัดที่ยาวที่สุด
```
...
```text
เขียนโค้ดที่เหลือด้วยตนเอง ถาม AI แค่คำสั่ง ljust()
```
...
```text
ljust() คือการเติมช่องว่างด้านขวาจนข้อความมีความยาว n
```
