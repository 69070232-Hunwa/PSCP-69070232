...
```text
รับค่าสมาชิก จำนวนของที่จะซื้อ และราคาของแต่ละอย่าง เพื่อนำมาคิดราคาสุทธิที่ต้องจ่าย
...
```text
รับค่สมาชิก จำนวนสินค้า ราคาของสินค้าแต่ละอย่าง แล้วตรวจสอบว่าจะลดราคาเท่าไหร่ หรือจ่ายในราคาปกติ
```
...
```text
รับค่าสมาชิก จำนวนของ ราคาของแต่ละอย่าง นำราคามาบวกกัน โดยถ้าเป็นสมาชิกจะได้ลดราคา 5% จากราคาเต็มทุกกรณี แต่ถ้าไม่เป็นสมาชิก ต้องมียอดรวมตั้งแต่ 500 บาทขึ้นไปก่อนลดราคา จะได้ลด 3% จากนั้นแสดงราคาที่ต้องจ่ายสุทธิเป็นทศนิยม 2 ตำแหน่ง
```
...
```text
กรณีไม่เป็นสมาชิก ยอดรวมน้อยกว่า 500 บาท
```
...
```text
กรณีไม่เป็นสมาชิก ยอดรวมมากกว่า 500 บาท
```
