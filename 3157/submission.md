...
```text
หาคะแนนรวมทั้งหมดจากเครื่องหมายที่รับค่า
```
...
```text
รับค่าจำนวนเครื่องหมายและเครื่องหมาย แล้วดูว่าคะแนนรวมเป็นเท่าไหร่
```
...
```text
รับค่าจำนวนเครื่องหมาย และเครื่องหมาย โดยที่ถ้าเป็น + เพิ่ม 10 และ - ลด 5 ให้ SCORE = 0 แล้วเพิ่มค่าจากเครื่องหมายเข้าไปใน SCORE 
```
