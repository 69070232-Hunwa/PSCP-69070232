...
```text
รับค่าสี rgb ทั้ง 2 สี ใช้สูตรจากโจทย์ผสมกัน
```
...
```text
รับค่าสี rgb ทั้ง 2 สี นำค่า r g และ b ของแต่ละสีมาบวกกันและหาร 2 จะได้สีที่ผสมกัน จากนั้นแสดงค่า rgb ใหม่ เป็นจำนวนเต็ม
```
