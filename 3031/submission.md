...
```text
รับค่าพื้นที่หมึก และจำนวนคนที่โดน และรับค่าพิกัดตามจำนวนคน จากนั้นตรวจสอบว่าพิกัดของคนเหล่านั้นจะโดนเมื่อไหร่
```
...
```text
รับค่าพื้นที่หมึก และจำนวนคนที่โดน และรับค่าพิกัดตามจำนวนคน หาระยะห่างของพิกัดของแต่ละคนจากจุดเริ่มต้น แล้วนำมาหาว่าจะโดนวินาทีที่เท่าไหร่
```
...
```text
รับค่าพื้นที่หมึก และจำนวนคนที่โดน และรับค่าพิกัดตามจำนวนคน ใช้ loop จากนั้นหาค่าระยะห่าง พื้นที่ เพื่อนำมาหาเวลา ของแต่ละคน ปัดเศษทศนิยมแล้วเก็บใน list สุดท้ายเรียก loop มาแสดงค่าทั้งหมดใน list
```
...
```text
อธิบายโจทย์ว่าเราต้องใช้ค่าอะไรมาคิดบ้าง และคำสั่ง
```
