...
```text
ตรวจสอบสลากกินแบ่งวาตรงกับเงื่อนไขไหน จะได้รับเงินเท่าไหร่
```
...
```text
รับตัวอักษรและเลขที่ซื้อและผลที่ออก แล้วตรวจสอบว่าเข้าเงื่อนไขไหน แสดงค่าเงินรางวัล
```
...
```text
รับค่าตัวอักษรและเลขที่ซื้อ และที่ผลออก ตัวอักษรตรวจสอบว่าตรงหรือไม่ หมวนตัวเลขใช้วิธีเลขตำแหน่ง โดยตรวจสอบตามเงื่อนไขของโจทย์ว่าตรงกับเงื่อนไขไหน แสดงค่าเงินรางวัล ถ้าไม่ตรงเลยจะไม่ได้เงินรางวัล
```
...
```text
กรณีถูกเลขท้าย 2 ตัว และตัวอักษรตรง
```
