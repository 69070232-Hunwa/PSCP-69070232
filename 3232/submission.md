...
```text
หาว่าต้องกระโดดกี่ครั้งถึงจะถึงจุดหมาย
```
...
```text
รับค่ากระโดดครั้งแรก แล้วลดลงทีละ 2 เอามารวมกันว่าต้องบวกกี่ครั้ง
```
...
```text
รับค่ากระโดดครั้งแรก และระยะทาง จากนั้นสร้างตัวแปรเพื่อเก็บค่าว่ากระโดดได้ทั้งหมดกี่เมตร ลดลงทีละ 2 เรื่อยๆ จนกระโดดต่อไม่ได้ โดยถ้าระยะรวมมากกว่าหรือเท่ากับระยะทางทั้งหมดจะแสดงว่ากระโดดกี่ครั้ง ถ้าน้อยกว่าแสดง -1
```
...
```text
กรณีกระโดดครั้งแรกกับระยะทางเท่ากัน
```
