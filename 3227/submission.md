...
```text
รับค่าชื่อย่อไพ่แล้วแปลงเป็นชื่อเต็ม
```
...
```text
รับค่าชื่อย่อไพ่ แล้วตรวจว่าแต่งละตัวอักษรในชื่อย่อมากจากชื่อเต็มอะไร
```
...
```text
รับค่าชื่อย่อไพ่ โดยจะมีแบบที่เป็น 2 และ 3 ตัวอักษร โดยถ้าเป็นตัวเลขจะแสดงเป็นตัวเลขเหมือนเดิม แต่ถ้าเป็นตัวอักษรจะถูกเปลี่ยนให้เป็นชื่อเต็ม ใช้วิธีเชคตำแหน่ง สุดท้ายนำทุกตัวที่แปลงเป็นชื่อเต็มได้มารวมกัน
```
