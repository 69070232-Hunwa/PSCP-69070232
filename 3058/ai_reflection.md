...
| OJ submission ID, if submitted | 568952 |
| OJ status | Pass |
...
```text
เกี่ยวกับการแก้ไข เนื่องจากส่งรอบแรกแล้วไม่ผ่าน
```
...
```text
ในกรณีที่อิฐเกินยังสามารถสร้างได้ แค่ต้องลดจำนวนลง
```
...
```text
ลองคิดสูตรด้วยตัวเอง แล้วลลองส่งให้ AI เชค
```
...
```text
ต้องดูว่ามันสามารถสร้างได้ไหม ถ้าอิฐเยอะไปเราลดจำนวนได้ แต่ถ้าน้อยไปจะสร้างไม่ได้
```
