...
```text
รับค่าอิฐก้อนเล็ก อิฐก้อนใหญ่ และความยาวของสะพาน จากนั้นดูว่าต้องใช้อิฐก้อนเล็กกี่ก้อน แต่ถ้าสร้างไม่ได้ ให้แสดง -1
```
...
```text
รับค่าอิฐก้อนเล็ก อิฐก้อนใหญ่ และความยาวของสะพาน จากนั้นนำอิฐก้อนเล็กคูณ 1 และก้อนใหญ่คูณ 5 แล้วตรวจสอบว่าสร้างได้ไหม
```
...
```text
รับค่าอิฐก้อนเล็ก อิฐก้อนใหญ่ และความยาวของสะพาน โดยเราต้องคิดใหม่ทั้งหมด คือ นำความยาวไปหาร 5 และเปรียบเทียบกับค่าอิฐก้อนใหญ่ แล้วเลือกค่าที่น้อย จากนั้นหาจำนวนเศษความยาวที่เหลือด้วยการเอาความยาวสะพานลบกับความยาวของอิฐก้อนใหญืที่เลือกใช้ โดยถ้าอิฐก้อนเล็กที่ได้ น้อยกว่าหรือเท่ากับ input ให้แสดงค่าที่คิดได้ เพราะถือว่าสามารถสร้างได้ นอกเหนือจากนั้นให้แสดง -1
```
...
```text
อธิบายว่าไม่สามารถเชคจาก input ต้องนำมาคิดใหม่
```
