...
```text
หาแถบจาก L (แนวแทยง) และ N (จำนวนทั้งหมด)
```
...
```text
ลองไล่เลขดูทีละแถบ นับช่อง แล้วดูว่าเลขสุดที่แถบไหน
```
...
```text
รับค่า L และ N หาเลขตัวแรกและตัวสุดท้ายของแถบนั้น เอาเลขรวมกันดูว่ามีกี่ช่อง แล้วบวกเข้าในตัวแปร total ถ้ามากกว่าหรือเท่ากับ N แสดงว่าเป็นแถบที่ N อยู่
```
