...
```text
รับค่าเลขห้องแล้วให้หาว่าเราต้องพังกำแพงยังไงให้ไปถึงห้องแรก
```
...
```text
รับค่าเลขห้องแล้วดูว่าเลขนั้นอยู่ชั้นไหน แล้วเชคความเชื่องโยงของจำนวนชั้นกับจำนวนกำแพงที่ต้องพัง
```
...
```text
รับค่าหมายเลขห้อง ถอดรูทเลขห้อง ปัดเศษขึ้น เก็บเป็นค่า n เพื่อดูว่าห้องอยู่ชั้นไหน ต่อมา -1 ว่าห่างจากห้องแรกกี่ชั้น จำนวนกำแพงที่ต้องพังจะเท่ากับ 2 เท่าของ n  จากนั้นตรวจสอบว่าเป็นเลขคู่หรือเลขคี่ เนื่องจากตำแหน่งเลขคี่ จะม่ค่าน้อยกว่าตำแหน่งเลขคู่อยู่ 1 กำแพงของชั้นนั้น ตรวจสอบว่าเลขคู่หรือคี่เยื้องฝั่งไหน เชคว่าจุดที่ปักกับหมายเลขห้องเท่ากันไหม ถ้าไม่เท่ากันกำแพงลดลง 1
```
...
```text
กรณีหมายเลขห้องเลขคี่ในชั้นเดียวกับ Test 2
```
...
```text
อธิบายสูตรเกี่ยวกับการพังกำแพง แพทเทิร์นเลขคู่เลขคี่
```

คุณยังทำอะไรด้วยตนเอง

```text
หาว่าเลขห้องอยู่ชั้นไหน
```
