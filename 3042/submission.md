...
```text
รับค่าเลขมาจำนวนหนึ่ง แล้วหาว่าตั้งแต่จำนวนนั้นถึง 0 มีเลขไหนบ้างที่หาร 10 ลงตัว
```
...
```text
รับค่าตัวเลข แล้วเอามาหาร 10 ไปเรื่อยๆ
```
...
```text
รับค่าตัวเลข แล้วนำมาลบด้วยเศษของเลขนั้นหารด้วย 10 สร้าง list เป็น loop ที่เริ่มจากตัวที่หาร 10 ลงตัวที่มากที่สุด ลดลงเรื่อยๆทีละ 10 จนถึง 0 สุดท้ายแสดงค่าที่ได้ทั้งหมดคั่นด้วยเว้นวรรค
```
...
```text
แสดงค่าเลขทั้งหมดที่ 10 หารลงตัว โดยใช้วิธี loop
```

คุณยังทำอะไรด้วยตนเอง

```text
คิดสูตรว่าจะต้องเริ่มถอยหลังจากตัวไหน
```
