...
| OJ submission ID, if submitted | 571735 |
| OJ status | Pass |
...
```text
สร้าง list เพื่อเก็บค่า และ output ให้แสดงแค่สระที่เจอ
```
...
```text
1. ต้องสร้าง list 2 ตัว คือ ตัวที่เก็บค่าสระ และตัวอักษรที่เป็นสระ 
2. ใช้ loop เพื่อเชคค่าสระที่ได้ทั้ง 5 ตัว แล้วเลือกแสดงค่าเพียงตัวที่มากกว่า 0
```
...
```text
ลองสร้าง list ตัวอักษรที่เป็นสระ และที่เป็นตัวเก็บค่าสระ
```
...
```text
ตำแหน่งของ list เริ่มนับตั้งแต่ 0 และสามารถเลือกแสดงแค่สระที่เจอได้
```
