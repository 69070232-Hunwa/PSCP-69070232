...
```text
สร้าง input รับข้อความ จากนั้นเชคทีละตัวว่าใช่สระไหม
```
...
```text
รับข้อความ สร้าง list เก็บค่าสระ และจำนวนสระที่นับได้  ใช้ loop พร้อมแปลงข้อความเป็นพิมพ์เล็ก จากนั้นเชคแต่ละตัวอักษรในข้อความว่าใช่สระไหม ถ้าใช่ให้บวกเพิ่มทีละ 1 ตามตำแหน่งใน list สุดท้ายให้แสดงค่าเพียงสระที่พบในข้อความ
```
