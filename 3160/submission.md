...
```text
รับค่าช่วงจำนวน หาจำนวนเฉพาะในช่วงนั้น และมีทั้งหมดกี่ตัว
```
...
```text
รับค่าช่วงจำนวน แล้วหาจำนวนเฉพาะ โดยที่จำนวนเฉพาะจะหาลงตัวแค่ 1 และตัวมันเอง
```
...
```text
รับค่าช่วงจำนวน เชคเลขแต่ละค่าในช่วง โดยที่จะพิจารณาจาก 2 ขึ้นไป ให้เป็นค่า True จากนั้นนำจำนวนที่ยังเหลือหารด้วย i แล้วถ้าหารลงตัว จะไม่ใช่จำนวนเฉพาะ เป็นค่า False นำค่าที่ยังเป็น True อยู่เก็บเข้าลิสต์ จากนั้นแสดงผลว่ามีเลขไหนบ้างที่เป็นจำนวนเฉพาะ และจำนวนเลขที่เป็นจำนวนเฉพาะ
```
