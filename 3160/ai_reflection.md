...
| OJ submission ID, if submitted | 638042 |
| OJ status | Pass |
...
```text
ดูเงื่อนไขโจทย์ไม่ครบ
ตัวแปรที่ไม่ได้ใช้ 
การเก็บค่าเป็น boolean
```
...
```text
เชคแล้วรูปแบบ output ไม่ตรง testcase
ต้องคิดตั้งแต่ค่าเริ่มต้นใน input 
```
...
```text
ต้องดูรูปแบบ output ให้รอบคอบ
ใช้ boolean ตรวจสอบค่าได้
```
