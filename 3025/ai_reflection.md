...
code ถูกต้องแต่ไม่ผ่านไม่ได้ 100%

## 5. AI ช่วยให้ฉันสังเกตอะไร

month % 3 == 0 สามารถเขียนอีกแบบให้สั้นลงเป็น not month % 3

## 6. ฉันตรวจสอบหรือแก้อะไรด้วยตนเอง

ไม่มี ติดปัณหาแค่จุดเดียว
## 7. ฉันได้เรียนรู้อะไร

ใช้คำสั่ง not แทน == 0 เพื่อให้ code สั้งลงได้
