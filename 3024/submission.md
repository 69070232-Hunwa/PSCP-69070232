...
```text
รับค่าคะแนนรวม และคะแนนน้อยที่สุด แล้วเชคว่าคนที่ได้คะแนนมากสุดและน้อยสุด คะแนนต่างกันมากกว่า 2 หรือไม่
...
```text
สร้าง input รับค่าคะแนนรวม และคะแนนสูงสุด  จากนั้นนำมาคิดผลต่าง แล้วแยกคิดกรณี
```
...
```text
สร้าง input รับค่าคะแนนรวม และคะแนนสูงสุด สร้างกรณีสมมติให้ 2 คนแรกได้คะแนนสูงสุด แล้วนำลบออกจากคะแนนรวม เพื่อให้ได้คแนนที่ต่ำที่สุดที่เป็นไปได้ จากนั้นต้องกำหนดว่าคะแนนน้อยกว่าศูนย์ไม่ได้ สุดท้ายตรวจสอบว่าคะแนนสูงสุดและต่ำสุดต่างกันเกิน 2 หรือไม่
```
...
```text
กรณีที่คะแนนรวมกับสูงสุดใกล้เคียงกัน เช่น testcase นี้ เท่ากับว่าอีก 2 คนที่เหลือ จะมีคนได้เพียง 1 คะแนน และ 0 คะแนน
```
...
```text
กรณีที่คะแนนรวมกับสูงสุดเท่ากัน ทำให้อีก 2 คนที่เหลือ ได้ 0 คะแนน
```
...
```text
กรณีที่คะแนนต่างกันเกิน 2 คะแนน
```
...
```text
เกี่ยวกับกรณีที่สมการคำนวณมาแล้วติดลบ ซึ่งคะแนนติดลบไม่ได้
```

คุณยังทำอะไรด้วยตนเอง

```text
คิด code ในส่วนของสมการ
```
