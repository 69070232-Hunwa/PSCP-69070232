...
| OJ submission ID, if submitted | 553548 |
| OJ status | Pass |
...
```text
ต้องคิดวิธีหาคนที่คะแนนต่ำสุดยังไง
```
...
```text
ต้องคิดในมุมที่คนที่ได้คะแนนมากสุดได้เท่ากัน 2 คน เพื่อหาคะแนนต่ำสุดที่เป็นไปได้
```
...
```text
สร้างสมการคือ คนที่คะแนนต่ำสุด จะเท่ากับคะแนนรวม ลบด้วยสองเท่าของคะแนนมากสุด
```
...
```text
ต้องคิดกหาคะแนนต่ำที่สุด ให้ค่าได้น้อยที่สุด
```
