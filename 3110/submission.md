...
```text
ตรวจสอบค่าธรรมเนียมส่งพัสดุ จากต้นทาง-ปลายทาง และน้ำหนัก
```
...
```text
รับค่าต้นทางปลายทาง น้ำหนัก แล้วคำนวนหาค่าธรรมเนียมจากน้ำหนักของพัสดุในแต่ละเส้นทาง แล้วบวกกับค่าธรรมเนียมเริ่มต้น  หากเส้นทางไม่อยู่ในค่าที่กำหนดจะคิดค่าธรรมเนียมไม่ได้ 
```
...
```text
เหมือนแผนแรก นำไปตรวจสอบว่าต้นทางปลางทางที่รับค่าต้อใช้อัตราเท่าไหร่แล้วนำน้ำหนักไปคูณพร้อมบวกค่าเริ่มต้น
```
